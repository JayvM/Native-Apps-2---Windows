...
using NativeAppsII_Services.Controllers;
using Owin;

//[assembly: OwinStartup(typeof(NativeAppsII_Services.AppOAuthProvider))]
...
namespace NativeAppsII_Services
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>  
        private UserController databaseManager = new UserController();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = databaseManager.LogIn(usernameVal, passwordVal);
            ...
            // Setting  
            claims.Add(new Claim(ClaimTypes.Name , userInfo.Gebruikersnaam));
            ...
            AuthenticationProperties properties = CreateProperties(userInfo.Gebruikersnaam,userInfo.Role,userInfo.Id.ToString());
